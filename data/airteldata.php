                ...
                <form method="post" action="../purchase/data.php">
                    <div class="MOBILEMTN">
                        <a href="airteldata.php">
                            <div class="mtnlogo">
                                <img src="../css/imgs/airteldataupdate.png" alt="Airtel">
                            </div>
                        </a>
                    </div>
                    <div class="fig">
                        ...
                        <select id="plans" name="plans">
                            ...
                            curl_setopt_array(
                                $curl,
                                array(
                                    CURLOPT_URL => 'https://gsubz.com/api/plans?service=airtel_cg',
                            ...
                            if ($responseArray !== null) {
                                ...
                                echo"<script>";
                                echo"alert('Airtel Service is currently down')";
                                echo"</script>";
                            }
                            ?>
                        </select>
                    ...
                    <input type="hidden" class="hidden-input" name="item" value="AIRTEL">
