...
<head>
    ...
    <title>STARTIMES SUBSCRIPTION</title>
            ...
            <div class="network">
                <form method="post">
                    <div class="MOBILEMTN">
                        <a href="dstvsub.php">
                            <div class="mtnlogo">
                                <img src="../css/imgs/startimesupdate.png" alt="dstv">
                            </div>
                        </a>
                    </div>
                    <div class="fig">
                        ...
                        <select id="plans" required name="plans">
                            <option value="nova">STARTIMES NOVA - N1500</option>
                            <option value="basics">STARTIMES BASIC - N2600</option>
                            <option value="smart">STARTIMES SMART - N3500</option>
                            <option value="classic">STARTIMES CLASSIC - N3800</option>
...
if (isset($_POST['submit'])) {
    ...
    $product = "STARTIMES SUBSCRIPTION";
