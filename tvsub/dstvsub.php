            ...
            <div class="network">
                <form method="post">
                    <div class="MOBILEMTN">
                        <a href="dstvsub.php">
                            <div class="mtnlogo">
                                <img src="../css/imgs/dstvupdate.png" alt="dstv">
                            </div>
                        </a>
                    </div>
                    <div class="fig">
                        ...
                        <select id="plans" required name="plans">
                            <option value="yanga-extra">DSTV YANGA + EXTRAVIEW - N8200</option>
                            <option value="dstv-padi">DSTV PADI - N2950</option>
                            <option value="dstv-yanga">DSTV YANGA - N4200</option>
                            <option value="dstv-confam">DSTV CONFAM - N7400</option>
                            <option value="dstv79">DSTV COMPACT - N12500</option>
                            <option value="dstv7">DSTV COMPACT PLUS - N19800</option>
                            <option value="dstv3">DSTV PREMIUM - 29500</option>
                            <option value="dstv6">DSTV ASIA - N9900</option>
                            <option value="extraview-access">DSTV XTRAVIEW ACCESS - N4000</option>
                            <option value="dstv30">DSTV COMPACT + EXTRAVIEW - N16500</option>
                        </select>
...
if (isset($_SESSION['username'])) {
    ...
    if ($conn->connect_error) {
        die("Database Connecton failed: " . $conn->connect_error);
    }
