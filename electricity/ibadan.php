...
<head>
    ...
    <title>IBADAN ELECTRICITY</title>
    <style>
        span {
            color: green;
        }
                ...
                <form method="post">
                    <div class="MOBILEMTN">
                        <a href="../electricity/ibadan.php">
                            <div class="mtnlogo">
                                <img src="../css/imgs/ibedc.jpg" alt="EKEDC">
                            </div>
                        </a>
                    </div>
                    <div class="figa">
...
if (isset($_POST["submit"])) {
    if (!is_numeric($amount) || $amount < 100) {
        ...
        $item = "Ibadan Electricity Distribution Company";
        $receiver = $customer;
        ...
        curl_setopt_array(
            ...
            array(
                ...
                CURLOPT_POSTFIELDS => array('serviceID' => 'ibadan_electric', 'api' => 'ap_83c2ee17ca19e2c34e29a0f17cd5bd89', 'amount' => $amount, 'phone' => $number, 'customerID' => $customer),
        ...
        if ($response['status'] === 'TRANSACTION_FAILED') {
            ...
            $responseMessage = 'You have successfully paid the sum of ' . $amount . ' for IBADAN ELECTRICITY for ' . $customer;
            $_SESSION["message"] = $responseMessage;
