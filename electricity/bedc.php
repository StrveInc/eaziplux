    ...
    <main>
        <div class="container">
            <div class="network">
                <form method="post">
                    <div class="MOBILEMTN">
                        <a href="../electricity/bedc.php">
                            <div class="mtnlogo">
                                <img src="../css/imgs/bedc.png" alt="AEDC">
                            </div>
                        </a>
                    </div>
                    <div class="figa">
                    ...
                    </div> <input class="submit" name="submit" type="submit" value="Buy Electricity">
                </form>
            </div>
        </div>
    </main>
...
if (isset($_POST["submit"])) {
    if (!is_numeric($amount) || $amount < 100) {
        ...
        $item = "Benin Electricity Distribution Company";
        $receiver = $customer;
        ...
        curl_setopt_array(
            ...
            array(
                ...
                CURLOPT_POSTFIELDS => array('serviceID' => 'benin_electric', 'api' => 'ap_83c2ee17ca19e2c34e29a0f17cd5bd89', 'amount' => $amount, 'phone' => $number, 'customerID' => $customer),
        ...
        if ($response['status'] === 'TRANSACTION_FAILED') {
            ...
            $responseMessage = 'You have successfully paid the sum of ' . $amount . ' for BEDC ELECTRICITY for ' . $customer;
            $_SESSION["message"] = $responseMessage;
