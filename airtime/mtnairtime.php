            ...
            <div class="network">
                <form method="post" action="../purchase/airtime.php" id="airtimeForm">
                    ...
                    <div class="fig">
                        ...
                        <input type="text" class="amount" name="amount" placeholder="100 -10,000" required></input>
                    </div>
                    <div class="num">
                        <p>NG</p>
                        <input type="text" class="number" name="number" placeholder="08012345678" required>
                    </div>

                    <input type="hidden" class="hidden-input" name="item" value="mtn">
