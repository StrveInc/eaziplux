...
<head>
    ...
    <style>
        ...
        .hidden-input {
            display: none; /* This will hide the field from the user */
        }
    </style>
</head>
...
<body>
            ...
            <div class="network">
                <form method="post" action="../purchase/airtime.php" id="airtimeForm">
                    ...
                    <div class="fig">
                        ...
                        <input type="text" class="amount" name="amount" placeholder="100 -10,000">
                    </div>
                    <div class="num">
                        <p>NG</p>
                    ...
                    <input class="submit" id="submitBtn" name="submit" type="submit" value="Buy Airtime">
                </form>
            </div>
        </div>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Select the form element by its ID to avoid potential conflicts
